        ...
        return (
            <div>
                <Row className="cart-item d-flex justify-content-space align-items-center">
                    ...
                    <Col xs={8} sm={9} className="d-flex flex-column flex-sm-row justify-content-sm-between align-items-center">
                        <div className="cart-info-item"><b>{product.title}</b></div>
                        <div className="cart-info-item d-flex justify-content-sm-end align-items-center">
                        ...
                        <div className="cart-info-item d-flex justify-content-sm-end"><b>{product.price}$</b></div>
                    </Col>
                </Row>
                {
